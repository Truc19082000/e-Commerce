...
<?php
	...
	if ($soluong == "") {
        ...
        $chi_tiet_san_pham = nl2br($chi_tiet_san_pham, FALSE);
        $mieu_ta = $_POST['mieu_ta'];
        $mieu_ta = nl2br($mieu_ta, FALSE);
	$sl= "update san_pham set tensp='".$name."',giasp=".$cost.",soluong=".$soluong.",img='".$image."',img1='".$img1."',img2='".$img2."',img3='".$img3."',img4='".$img4."',loaisp='".$loaisp."',chi_tiet_san_pham='".$chi_tiet_san_pham."',mieu_ta='".$mieu_ta."' where masp=".$masp;
	$sql= "update cau_hinh set nha_sx='".$nha_sx."' where masp=".$masp;
