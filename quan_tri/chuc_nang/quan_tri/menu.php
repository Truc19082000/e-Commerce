...
<?php
	...
	switch($menu){
		...
		case 'ql_sanpham': include('chuc_nang/san_pham/ql_sanphams.php'); break;
		...
		case 'logout': include('chuc_nang/quan_tri/logout.php'); break;
                case 'nguoi_dung': include('chuc_nang/quan_tri/nguoi_dungs.php'); break;
                case 'binh_luan': include('chuc_nang/quan_tri/binh_luan.php'); break;
                case 'chi_tiet_thanh_vien': include('chuc_nang/hoa_don/chi_tiet_thanh_vien.php'); break;
		...
		default: include('chuc_nang/quan_tri/contents.php'); break;
		...
		case 'hoa_don': include('chuc_nang/hoa_don/hoa_dons.php'); break;
		case 'chi_tiet': include('chuc_nang/san_pham/chi_tiet.php'); break;
                
                case 'sua_csbm': include('chuc_nang/quan_tri/sua_csbm.php'); break;
		case 'them_csbm': include('chuc_nang/quan_tri/them_csbm.php'); break;
                case 'exec_them_csbm': include('chuc_nang/quan_tri/exec_them_csbm.php'); break;
		case 'exec_sua_csbm': include('chuc_nang/quan_tri/exec_sua_csbm.php'); break;
		case 'ql_csbm': include('chuc_nang/quan_tri/ql_csbm.php'); break;
	}
}
else{
	include('chuc_nang/quan_tri/contents.php');
}
?>