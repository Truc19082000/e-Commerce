    ...
    while ($row = mysqli_fetch_array($exec)) {
        ...
        <tbody id="myTable">
            <tr>
                ...
                <td><a  href="?menu=chi_tiet_thanh_vien&username=<?php echo $row['username']; ?>">Chi tiết</a></td>
                <td><a onclick="return confirm('Bạn chắc chắn muốn xóa không?');" href="?menu=xoa_tt_admin&id=<?php echo $row['id']; ?>">Xóa</a></td>
            </tr>    
        </tbody>
        <?php } ?>
    </table>
