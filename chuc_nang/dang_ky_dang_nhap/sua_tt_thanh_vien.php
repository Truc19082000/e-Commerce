...
<div class="panel panel-primary">
    <div class="panel-heading"><h3 style="text-align: center; font-family: Comic Sans MS;">Sửa thông tin thành viên</h3></div>
    <div style="width: 80%; margin-left: 10%; padding: 8px; border: 10px groove salmon; word-wrap: break-word; border-radius: 20px;">
