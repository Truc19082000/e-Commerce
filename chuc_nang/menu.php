	...
	if(isset($_GET['menu'])){
		...
		switch($menu){ 
			...
			case 'san_pham': include('chuc_nang/san_pham/san_pham.php'); break;
                        case 'tat_ca': include('chuc_nang/san_pham/tat_ca.php'); break;
			...
			case 'addcart': include('chuc_nang/san_pham/add_cart.php'); break;
                        ...
                        case 'addlist': include('chuc_nang/san_pham/add_list.php'); break;
                        case 'del_list': include('chuc_nang/yeu_thich/del_list.php'); break;
			case 'thanh_toan': include('chuc_nang/gio_hang/thanh_toan.php'); break;
                        case 'thanh_toan_khi_nhan_hang': include('chuc_nang/gio_hang/thanh_toan_khi_nhan_hang.php'); break;
			...
			case 'cpu': include('chuc_nang/san_pham/cpu.php'); break;
                        case 'ram': include('chuc_nang/san_pham/ram.php'); break;
                        case 'tainghe': include('chuc_nang/san_pham/tainghe.php'); break;
                        case 'chuot': include('chuc_nang/san_pham/chuot.php'); break;
                        case 'lotchuot': include('chuc_nang/san_pham/lotchuot.php'); break;
                        case 'manhinh': include('chuc_nang/san_pham/manhinh.php'); break;
                        case 'taycam': include('chuc_nang/san_pham/taycam.php'); break;
                        case 'banphim': include('chuc_nang/san_pham/banphim.php'); break;
			...
			case 'huong_dan_mua_hang': include('chuc_nang/footer/huong_dan_mua_hang.php'); break;
                        case 'chinh_sach_bao_mat': include('chinh_sach_bao_mat.php'); break;
                        
                        case 'xoa': include('chuc_nang/hoa_don_user/xoa.php'); break;
                        case 'chi_tiet_hoa_don': include('chuc_nang/hoadon_user/chi_tiet_hoa_don.php'); break;
