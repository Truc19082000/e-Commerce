...
<div class="section">
    ...
    <div style="background-color: #00897b; padding-top: 1em; height: 60px;">
        <div><h3 style="text-align: center; font-family: Comic Sans MS; color: white;">LÓT CHUỘT</h3></div>
    </div>
    <div class="container">
        <!-- row -->
        <div class="row">
            ...
            <div id="store" class="col-md-9">
                ...
                $page = $page - 1;
                $limit = 6;
                $sql = "select * from san_pham where loaisp like 'lotchuot'";
                ...
                <div class="row">
                    <?php
                    include('connect.php');
                    $sl = "select * from san_pham where loaisp like 'lotchuot' limit " . $start . "," . $limit;
                    $exec = mysqli_query($connect, $sl);
                    while ($row = mysqli_fetch_array($exec)) {
                        ?>  
                        <!-- product -->
                ...
                <div class="store-filter clearfix">
                    <nav>
                        <ul class="store-pagination">
                            ...
                            for ($i = 1; $i <= $total; $i++) {
                                ?>
                                <li><a href="?menu=lot_chuot&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php
                            }
                            ?>
                        </ul>
